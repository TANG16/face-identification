...
load myFaceRecognitionModelClearnMergedGrayscale128_3fold.mat
...
for foldId = 1:1
    ...
    sourceImageRootFolder = "/${source image folder}/";
    outputImageRootFolder= "/${output image folder}/";
    ...
    for j = 1:numberOfImages
        ...
        if isFaceDetectorUsed ~= 0
            bbox = MyFaceDetectionFunction(my_FRmodel.faceDetector, A);
        else
            bbox = [0 0 size(A)];
        end
